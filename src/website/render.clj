...
(defn resume-page []
  (page-shell
   ...
   (str
    ...
    "<p class=\"resume-title\">Software Engineer — Infrastructure</p>"
    ...
    "<h2>Profile</h2>"
    "<p>I manage Azure environments with a Linux tech stack. Microsoft Infrastructure Engineer with 5+ years experience in enterprise security software, IT automation, network security, and cloud services. Passionate about functional programming and Infrastructure as Code.</p>"
    "</div>"
